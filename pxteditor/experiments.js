...
exports.setState = exports.state = exports.toggle = exports.isEnabled = exports.someEnabled = exports.clear = exports.all = exports.syncTheme = exports.setEditorExtensionExperiments = void 0;
function key(experiment) {
    const id = (typeof experiment === "object") ? experiment.id : experiment;
    return `experiments-${id}`;
}
let editorExtensionExperiments;
function setEditorExtensionExperiments(experiments) {
    editorExtensionExperiments = experiments;
}
exports.setEditorExtensionExperiments = setEditorExtensionExperiments;
function syncTheme() {
...
exports.someEnabled = someEnabled;
