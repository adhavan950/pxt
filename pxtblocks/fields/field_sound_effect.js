...
exports.FieldSoundEffect = void 0;
...
class FieldSoundEffect extends field_base_1.FieldBase {
    constructor() {
        super(...arguments);
        ...
        this.onWorkspaceChange = (ev) => {
            ...
            if (!block || block !== this.sourceBlock_ && block.getParent() !== this.sourceBlock_)
                return;
            this.redrawPreview();
        };
    }
...
exports.FieldSoundEffect = FieldSoundEffect;
