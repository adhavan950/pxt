...
exports.FieldCustomMelody = exports.TOTAL_WIDTH = exports.HEADER_HEIGHT = void 0;
const Blockly = require("blockly");
var svg = pxt.svgUtil;
const field_utils_1 = require("./field_utils");
const field_matrix_1 = require("./field_matrix");
exports.HEADER_HEIGHT = 50;
exports.TOTAL_WIDTH = 300;
class FieldCustomMelody extends field_matrix_1.FieldMatrix {
    constructor(value, params, validator) {
        super(value, validator);
        this.isFieldCustom_ = true;
        this.SERIALIZABLE = true;
        this.soundingKeys = 0;
        this.numMatrixRows = 8;
        this.numMatrixCols = 8;
        this.tempo = 120;
        this.isPlaying = false;
        this.timeouts = []; // keep track of timeouts
        this.clearSelectionOnBlur = false;
        this.matrixFocusBind = null;
    ...
    getFieldDescription() {
        var _a, _b;
        const melodyString = (_b = (_a = this.melody.getStringRepresentation()) === null || _a === void 0 ? void 0 : _a.replace(/-/g, "")) === null || _b === void 0 ? void 0 : _b.trim();
    ...
    renderEditor(div) {
        ...
        this.toggle.layout();
        this.toggle.translate((exports.TOTAL_WIDTH - this.toggle.width()) / 2, TOGGLE_PADDING_TOP);
    ...
    getCellToggled(column, row) {
        return this.melody.getValue(row, column);
    }
    useTwoToneFocusIndicator(_x, _y) {
        return true;
    }
    updateGrid() {
    ...
    handleMatrixFocus(_e) {
        var _a;
        if (!this.selected) {
            const startNote = (_a = this.getMelodyNote(0)) !== null && _a !== void 0 ? _a : 0;
    ...
    attachPointerEventHandlersToCell(x, y, cellRect) {
    ...
    handleArrowLeft(x, y) {
        ...
        const existingY = (_a = this.getMelodyNote(newX)) !== null && _a !== void 0 ? _a : y;
...
exports.FieldCustomMelody = FieldCustomMelody;
// grid elements
FieldCustomMelody.CELL_WIDTH = 25;
FieldCustomMelody.CELL_HORIZONTAL_MARGIN = 5;
FieldCustomMelody.CELL_VERTICAL_MARGIN = 7;
