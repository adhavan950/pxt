...
class FieldPosition extends math_1.FieldSlider {
    ...
    renderScreenPicker() {
        ...
        this.resetCrosshair();
        Blockly.browserEvents.bind(this.selectorDiv_, 'mousemove', this, (e) => {
        ...
        Blockly.browserEvents.bind(this.selectorDiv_, 'click', this, (e) => {
            const bb = canvasOverlayDiv.getBoundingClientRect();
            const x = e.clientX - bb.left;
            const y = e.clientY - bb.top;
