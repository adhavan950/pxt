...
exports.FieldColorNumber = void 0;
const field_grid_dropdown_1 = require("@blockly/field-grid-dropdown");
const Blockly = require("blockly/core");
/**
 * Similar to Blockly's field_colour but with support for different colour
 * formats.
 */
class FieldColorNumber extends field_grid_dropdown_1.FieldGridDropdown {
    constructor(text, params, opt_validator) {
        var _a;
        let allColoursCSSFormat;
        let titles;
        const valueMode = (_a = params.valueMode) !== null && _a !== void 0 ? _a : "rgb";
    ...
    isFullBlockField() {
        ...
        return (this.blockIsSimpleReporter() &&
            Boolean(constants === null || constants === void 0 ? void 0 : constants.FIELD_COLOUR_FULL_BLOCK));
    }
    /**
    ...
    getSize() {
        var _a;
        if ((_a = this.getConstants()) === null || _a === void 0 ? void 0 : _a.FIELD_COLOUR_FULL_BLOCK) {
            // In general, do *not* let fields control the color of blocks. Having the
            // field control the color is unexpected, and could have performance
            // impacts.
    ...
    updateSize_(margin) {
        ...
        let totalHeight;
        if (this.isFullBlockField()) {
            const xOffset = margin !== null && margin !== void 0 ? margin : 0;
    ...
    doClassValidation_(newValue) {
        ...
        const normalizedValueFormat = cssFormatToValueFormat(cssFormat, this.valueMode_, this.allColoursCSSFormat_);
...
exports.FieldColorNumber = FieldColorNumber;
function makeSwatches(valueMode, allColoursCSSFormat, titles) {
...
function cssFormatToValueFormat(value_, valueMode, allColoursCSSFormat) {
    switch (valueMode) {
        case "hex":
            return `"${value_}"`;
        case "rgb":
...
function valueFormatToCSSFormat(value, allColoursCSSFormat) {
