...
const LIST_CREATE_MIXIN = {
    ...
    restoreConnections_: function () {
        var _a;
        for (let i = 0; i < this.itemCount_; i++) {
            (_a = this.valueConnections_[i]) === null || _a === void 0 ? void 0 : _a.reconnect(this, 'ADD' + i);
        }
    },
    addItem_: function () {
        ...
        if (this.itemCount_ > 1) {
            ...
            if (firstInput && firstInput.connection.targetConnection) {
                ...
                if (!newFieldType || newFieldType === newShadowType) {
                    ...
                    if (connectedBlock) {
                        if (newFieldType === constants_1.FUNCTION_CALL_OUTPUT_BLOCK_TYPE) {
    ...
    updateShape_: function () {
        ...
        if (this.itemCount_ > 0) {
            buttons.appendField(new field_imagenotext_1.FieldImageNoText(this.REMOVE_IMAGE_DATAURI, 24, 24, "*", remove, false));
        }
        buttons.appendField(new field_imagenotext_1.FieldImageNoText(this.ADD_IMAGE_DATAURI, 24, 24, "*", add, false));
...
Blockly.Blocks["lists_create_with"] = Object.assign(Object.assign({}, LIST_CREATE_MIXIN), { init: function () {
