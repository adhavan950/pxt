...
class Bubble {
    ...
    constructor(workspace, anchor, ownerRect, overriddenFocusableElement) {
         ...
         */
        this.size = new Blockly.utils.Size(0, 0);
        ...
        this.relativeLeft = 0;
        this.dragStrategy = new Blockly.dragging.BubbleDragStrategy(this, this.workspace);
        this.id = Blockly.utils.idGenerator.getNextUniqueId();
        this.svgRoot = dom.createSvgElement(Blockly.utils.Svg.G, { 'class': 'blocklyBubble' }, workspace.getBubbleCanvas());
        const embossGroup = dom.createSvgElement(Blockly.utils.Svg.G, {
        // 'filter': `url(#${this.workspace.getRenderer().getConstants().embossFilterId
        //     })`,
        }, this.svgRoot);
        this.tail = dom.createSvgElement(Blockly.utils.Svg.LINE, {
            'stroke-width': '3',
            'stroke-linecap': 'round'
        }, embossGroup);
        this.background = dom.createSvgElement(Blockly.utils.Svg.RECT, {
        ...
        this.topBar = dom.createSvgElement(Blockly.utils.Svg.RECT, {
            'class': 'blocklyCommentTopbarBackground',
            'x': Bubble.BORDER_WIDTH,
            'y': Bubble.BORDER_WIDTH
        }, embossGroup);
        this.deleteIcon = dom.createSvgElement(Blockly.utils.Svg.IMAGE, {
            'class': 'blocklyDeleteIcon',
            'href': `${workspace.options.pathToMedia}delete-icon.svg`,
        }, embossGroup);
        this.collapseIcon = dom.createSvgElement(Blockly.utils.Svg.IMAGE, {
            'class': 'blocklyFoldoutIcon',
            'href': `${workspace.options.pathToMedia}foldout-icon.svg`,
        }, embossGroup);
        this.focusableElement = overriddenFocusableElement !== null && overriddenFocusableElement !== void 0 ? overriddenFocusableElement : this.svgRoot;
        this.focusableElement.setAttribute('id', this.id);
        Blockly.browserEvents.conditionalBind(this.background, 'pointerdown', this, this.onMouseDown);
        Blockly.browserEvents.conditionalBind(this.topBar, 'pointerdown', this, this.onMouseDown);
        Blockly.browserEvents.conditionalBind(this.collapseIcon, 'pointerdown', this, this.onCollapseDown);
        Blockly.browserEvents.conditionalBind(this.deleteIcon, 'pointerdown', this, this.onDeleteDown);
    }
    ...
    onMouseDown(e) {
        var _b;
        (_b = this.workspace.getGesture(e)) === null || _b === void 0 ? void 0 : _b.handleBubbleStart(e, this);
     ...
     */
    positionByRect(rect = new Blockly.utils.Rect(0, 0, 0, 0)) {
    ...
    bringToFront() {
        var _b;
        const svgGroup = (_b = this.svgRoot) === null || _b === void 0 ? void 0 : _b.parentNode;
        if (this.svgRoot && (svgGroup === null || svgGroup === void 0 ? void 0 : svgGroup.lastChild) !== this.svgRoot) {
            svgGroup === null || svgGroup === void 0 ? void 0 : svgGroup.appendChild(this.svgRoot);
            return true;
        }
        return false;
    }
    ...
    getRelativeToSurfaceXY() {
        return new Blockly.utils.Coordinate(this.workspace.RTL
