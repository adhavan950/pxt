...
exports.DuplicateOnDragConnectionChecker = void 0;
...
class DuplicateOnDragConnectionChecker extends Blockly.ConnectionChecker {
    doDragChecks(a, b, distance) {
        if (!super.doDragChecks(a, b, distance))
            return false;
        const replacedBlock = b.targetBlock();
        if (replacedBlock &&
            (0, duplicateOnDrag_1.shouldDuplicateOnDrag)(replacedBlock) &&
            !(replacedBlock.isShadow() && (0, duplicateOnDrag_1.isAllowlistedShadow)(replacedBlock))) {
            return false;
        }
        if (!(0, utils_1.doArgumentReporterDragChecks)(a, b, distance)) {
            return false;
        }
        return true;
    }
    ...
    doSafetyChecks(a, b) {
        ...
        else if (inferiorConnection.type !== OPPOSITE_TYPE[superiorConnection.type]) {
        ...
        else if (inferiorConnection.type === Blockly.ConnectionType.OUTPUT_VALUE &&
        ...
        else if (inferiorConnection.type === Blockly.ConnectionType.PREVIOUS_STATEMENT &&
...
exports.DuplicateOnDragConnectionChecker = DuplicateOnDragConnectionChecker;
