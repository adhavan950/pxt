...
exports.createFunctionsFlyoutCategory = exports.mkReturnStatementBlock = exports.mkVariableFieldBlock = exports.mkFieldBlock = exports.mkPredicateBlock = exports.createToolboxBlock = exports.createFlyoutGap = exports.createFlyoutButton = exports.createFlyoutGroupLabel = exports.createFlyoutHeadingLabel = exports.createShadowValue = exports.isArrayType = void 0;
...
function createShadowValue(info, p, shadowId, defaultV, parentIsShadow, maxRecursion = 0) {
    ...
    let isEnum = (paramType === null || paramType === void 0 ? void 0 : paramType.kind) == pxtc.SymbolKind.Enum;
...
exports.createShadowValue = createShadowValue;
...
exports.createFlyoutHeadingLabel = createFlyoutHeadingLabel;
...
exports.createFlyoutGroupLabel = createFlyoutGroupLabel;
...
exports.createFlyoutButton = createFlyoutButton;
function createFlyoutGap(gap) {
    const sep = Blockly.utils.xml.createElement("sep");
    sep.setAttribute("gap", gap + "");
    return sep;
}
exports.createFlyoutGap = createFlyoutGap;
function createToolboxBlock(info, fn, comp, isShadow = false, maxRecursion = 0) {
    var _a, _b;
    let parent;
    let parentInput;
    ...
    if (comp.thisParameter) {
        ...
        const isFixedInstance = !!((_a = info.apis.byQName[t.type]) === null || _a === void 0 ? void 0 : _a.attributes.fixedInstances);
    ...
    if (fn.attributes.shim === "ENUM_GET" || fn.attributes.shim === "KIND_GET") {
        if ((_b = fn.parameters) === null || _b === void 0 ? void 0 : _b.length) {
        ...
        if (fn.attributes.draggableParameters) {
            comp.handlerArgs.forEach(arg => {
                ...
                const value = document.createElement("value");
                value.setAttribute("name", loader_1.DRAGGABLE_PARAM_INPUT_PREFIX + arg.name);
                ...
                mutation.setAttribute(functions_1.LOCALIZATION_NAME_MUTATION_KEY, arg.localizationKey);
                const field = document.createElement("field");
...
exports.createToolboxBlock = createToolboxBlock;
...
exports.mkPredicateBlock = mkPredicateBlock;
...
exports.mkFieldBlock = mkFieldBlock;
function mkVariableFieldBlock(type, id, typeString, name, isShadow) {
    const fieldBlock = document.createElement(isShadow ? "shadow" : "block");
    fieldBlock.setAttribute("type", pxt.Util.htmlEscape(type));
    const field = document.createElement("field");
    field.setAttribute("name", "VAR");
...
exports.mkVariableFieldBlock = mkVariableFieldBlock;
...
exports.mkReturnStatementBlock = mkReturnStatementBlock;
// Patch new functions flyout to add the heading
function createFunctionsFlyoutCategory(workspace) {
    const elems = (0, functions_1.flyoutCategory)(workspace);
    if (elems.length > 1) {
    ...
    const functionsWithReturn = (0, functions_1.getAllFunctionDefinitionBlocks)(workspace)
...
exports.createFunctionsFlyoutCategory = createFunctionsFlyoutCategory;
;
